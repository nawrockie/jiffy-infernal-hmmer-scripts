#!/usr/bin/env perl
# 
# cm-copy-evalue-parameters.pl: copy E-value parameters from one CM file into another
...
# 
my $usage;
$usage  = "cm-copy-evalue-parameters.pl <CM file with parameters to copy FROM> <CM file with parameters to copy TO>\n";
